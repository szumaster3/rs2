...
class StakeContainer(
    ...
    fun open() {
        ...
        PacketRepository.send(ContainerPacket::class.java, Context.ContainerContext(player, -1, 2, 93, player.inventory, false))
    }
    ...
    inner class StakeListener : ContainerListener {
        ...
        override fun refresh(c: Container?) {
            PacketRepository.send(
                ...
                Context.ContainerContext(player, -1, 2, 93, player.inventory, false)
            )
        }
    }
