...
class SeegudDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            START_DIALOGUE -> playerl(FaceAnim.HALF_ASKING, "Hello, there! Nice day, isn't it?").also { stage++ }
            ...
            2 -> playerl(FaceAnim.HALF_ASKING, "Makes your bones...itch? How does that work?").also { stage++ }
