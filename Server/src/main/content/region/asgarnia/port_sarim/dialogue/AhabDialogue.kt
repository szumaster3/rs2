    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                2 -> player(FaceAnim.HALF_ASKING,"Are you going to sit there all day?").also { stage = 20 }
                3 -> player(FaceAnim.HALF_ASKING,"Do you have anything for trade?").also { stage = 38 }
            }

            10 -> npc("Arrr, matey!").also { stage = 0 }
            20 -> npc("Aye, I am. I canna walk, ye see.").also { stage++ }
            21 -> player(FaceAnim.HALF_ASKING,"What's stopping you from walking?").also { stage++ }
            ...
            27 -> npc(FaceAnim.HALF_ASKING,"Perhaps a bright young laddie like yerself would like to", "help me? I be needing another ship to go a-hunting my", "enemy.").also { stage++ }
            28 -> if (!isQuestComplete(player, Quests.DRAGON_SLAYER)) {
            ...
            31 -> npc(FaceAnim.HALF_ASKING,"So would ye be kind enough to let", "me take her out to sea?").also { stage++ }
            32 -> player(FaceAnim.HALF_ASKING,"I had to pay 2000gp for that ship!", "Have you got that much?").also { stage++ }
            ...
            35 -> npc(FaceAnim.HALF_ASKING,"Arrr! Would ye be so kind?").also { stage++ }
