package content.region.asgarnia.goblin_village.quest.gobdip.cutscene;

import content.region.asgarnia.goblin_village.quest.gobdip.dialogue.GrubFoot;
...
public final class GoblinDiplomacyCutscene extends CutscenePlugin {
    ...
    public void open() {
        ...
        PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 4, player.getLocation().getY() + 1, 390, 1, 100));
        PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 2, player.getLocation().getY(), 390, 1, 100));
    }
