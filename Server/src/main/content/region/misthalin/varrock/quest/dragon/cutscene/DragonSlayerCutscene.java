...
public final class DragonSlayerCutscene extends CutscenePlugin {
    ...
    public void open() {
        ...
        PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 11, player.getLocation().getY() + 1, 190, 1, 100));
        PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 3, player.getLocation().getY(), 190, 1, 100));
        bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 7, player.getLocation().getY() - 3, 250, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 4, player.getLocation().getY(), 210, 1, 1));
    }
    ...
    public void end() {
        ...
        PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.RESET, player.getLocation().getX() + 13, player.getLocation().getY() - 3, 250, 1, 100));
        player.lock(3);
    }
     ...
     */
    public void bob(final Context.Camera position, final Context.Camera rotation) {
    ...
    public class BobingPulse extends Pulse {
        ...
        private Context.Camera position = null;

        private Context.Camera rotation = null;
        ...
        public boolean handle(int interfaceId, int buttonId) {
            switch (quest.getStage(player)) {
                ...
                case 30:
                    switch (stage) {
                        case 500:
                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 6, player.getLocation().getY() - 3, 350, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 2, player.getLocation().getY(), 190, 1, 1));
                            npc("And this is a mighty fine ship. She don't look much, but", "she handles like a dream.");
                            stage = 501;
                            break;
                        case 501:
                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 5, player.getLocation().getY() - 3, 350, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 1, player.getLocation().getY(), 350, 1, 1));
                            player.face(npc);
                            npc.face(player);
                        ...
                        case 503:
                            ...
                            GameWorld.getPulser().submit(new Pulse(6, player) {
                                ...
                                public boolean pulse() {
                                    ...
                                    stage = 504;
                                    PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 8, player.getLocation().getY() + 15, 1200, 1, 100));
                                    PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX(), player.getLocation().getY(), 1200, 1, 100));
                                    ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 5, player.getLocation().getY() + 18, 1200, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 2, player.getLocation().getY(), 1200, 1, 1));
                                    return true;
                                }
                            });
                            break;
                        case 504:
                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() - 2, player.getLocation().getY() + 14, 1000, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 2, player.getLocation().getY() - 50, 1000, 1, 1));
                        ...
                        case 507:
                            ...
                            break;
                        case 508:
                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 7, player.getLocation().getY() + 2, 400, 1, 100));
                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 3, player.getLocation().getY(), 400, 1, 100));
                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 8, player.getLocation().getY() + 5, 400, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 3, player.getLocation().getY(), 400, 1, 1));
                            close();
                        ...
                        case 509:
                            ...
                            GameWorld.getPulser().submit(new Pulse(1, player) {
                                ...
                                public boolean pulse() {
                                    switch (counter++) {
                                        case 2:
                                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 5, player.getLocation().getY() + 2, 400, 1, 100));
                                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 3, player.getLocation().getY(), 400, 1, 100));
                                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 7, player.getLocation().getY() + 2, 400, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 3, player.getLocation().getY(), 400, 1, 1));
                                        ...
                                        case 6:
                                            ...
                                            break;
                                        case 10:
                                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 13, player.getLocation().getY() + 2, 400, 1, 40));
                                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 3, player.getLocation().getY(), 400, 1, 40));
                                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 2, player.getLocation().getY() + 2, 400, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() - 4, player.getLocation().getY(), 400, 1, 1));
                        ...
                        case 510:
                            ...
                            ((DragonSlayerCutscene) cutscene).bob(new Context.Camera(player, Context.Camera.CameraType.POSITION, player.getLocation().getX() + 2, player.getLocation().getY() + 3, 350, 1, 1), new Context.Camera(player, Context.Camera.CameraType.ROTATION, player.getLocation().getX() + 70, player.getLocation().getY() - 30, 350, 1, 1));
                            player.face(npc);
                            stage = 511;
                            break;
                        case 511:
                        ...
                        case 512:
                            ...
                            PacketRepository.send(CameraViewPacket.class, new Context.Camera(player, Context.Camera.CameraType.SHAKE, 4, 4, 1200, 4, 4));
