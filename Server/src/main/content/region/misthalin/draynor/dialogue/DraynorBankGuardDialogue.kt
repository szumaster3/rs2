        ...
        when (stage) {
            0 -> {
                if (!player.getSavedData().globalData.isDraynorRecording()) {
                    options("Can I deposit my stuff here?", "That wall doesn't look very good.", "Sorry, I don't want anything.").also { stage++ }
                } else {
            ...
            70 -> when (buttonId) {
                1 -> player(FaceAnim.HALF_ASKING,"Can I see that recording again, please?").also { stage = 71 }
            ...
            74 -> options("Ok, you can take 50 gp from my bank account.", "Thanks, maybe another day.").also { stage = 76 }
            75 -> end()
            76 -> when (buttonId) {
            ...
            79 -> {
                ...
                if (inBank(player, Items.COINS_995, 50) && removeItem(
                        player,
            ...
            1 -> when (buttonId) {
                1 -> player(FaceAnim.HALF_ASKING, "Hello. Can I deposit my stuff here?").also { stage = 10 }
            ...
            22 -> when (buttonId) {
                1 -> player(FaceAnim.HALF_ASKING,"Are you going to tell me what happened?").also { stage = 25 }
            ...
            50 -> player(FaceAnim.HALF_ASKING,"But... was anyone hurt?", "Did they get anything valuable?").also { stage++ }
            ...
            53 -> player(FaceAnim.HALF_ASKING,"Oh, good... but the bank staff got hurt?").also { stage++ }
            54 -> npc("Yes but the new ones are just as good.").also { stage++ }
            55 -> player(FaceAnim.HALF_ASKING,"You're not very nice, are you?").also { stage++ }
            56 -> npc("No-one's expecting me to be nice.").also { stage++ }
            57 -> player(FaceAnim.HALF_ASKING,"Anyway... So, someone's robbed the bank?").also { stage++ }
            ...
            61 -> player(FaceAnim.HALF_ASKING,"You've got a security recording?").also { stage++ }
            62 -> npc("Yes. Our insurers insisted that we", "install a magical scrying orb.").also { stage++ }
            63 -> player(FaceAnim.HALF_ASKING,"Can I see the recording?").also { stage++ }
